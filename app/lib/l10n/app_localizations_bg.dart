...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get createPersonHint => 'Създайте нов човек и обучете Chronicle да разпознава и тяхната реч!';
  ...
  @override
  String get askOmi => 'Попитай Chronicle';
  ...
  @override
  String get deletingMessages => 'Изтриване на вашите съобщения от паметта на Chronicle...';
  ...
  @override
  String get chatWithOmi => 'Чат с Chronicle';
  ...
  @override
  String get getOmiForMac => 'Вземете Chronicle за Mac';
  ...
  String get privacyIntro =>
      'В Chronicle сме ангажирани със защитата на вашата поверителност. Тази страница ви позволява да контролирате как вашите данни се съхраняват и използват.';
  ...
  @override
  String get deviceDisconnectedMessage => 'Вашият Chronicle беше прекъснат 😔';
  ...
  @override
  String get yourOmiInsights => 'Вашите Chronicle прозрения';
  ...
  String get startConversationToSeeInsights =>
      'Започнете разговор с Chronicle,\nза да видите прозренията си за използване тук.';

  @override
  String get listening => 'Слушане';

  @override
  String get listeningSubtitle => 'Общо време, през което Chronicle активно е слушал.';
  ...
  @override
  String get shareStatsMessage => 'Споделям моите Chronicle статистики! (omi.me - вашият винаги включен AI асистент)';
  ...
  @override
  String get omiDebugLog => 'Chronicle дневник за отстраняване на грешки';
  ...
  @override
  String get exportedConversations => 'Експортирани разговори от Chronicle';
  ...
  String authAccessMessage(String appName) {
    return 'Ще трябва да упълномощите Chronicle за достъп до вашите $appName данни. Това ще отвори браузъра ви за удостоверяване.';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Как Chronicle да ви нарича?';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Ще трябва да упълномощите Chronicle за създаване на задачи в вашия $appName акаунт. Това ще отвори браузъра ви за удостоверяване.';
  }
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$device използва $reason. Ще се използва Chronicle.';
  }

  @override
  String get omiTranscription => 'Chronicle транскрипция';
  ...
  String get bluetoothNeeded =>
      'Chronicle се нуждае от Bluetooth, за да се свърже с вашето носимо устройство. Моля, активирайте Bluetooth и опитайте отново.';
  ...
  @override
  String get backgroundActivityDesc => 'Позволете на Chronicle да работи на заден план за по-добра стабилност';
  ...
  @override
  String get lovingOmi => 'Обичате ли Chronicle?';

  @override
  String get maybeLater => 'Може би по-късно';

  @override
  String get speechProfileIntro => 'Chronicle трябва да научи вашите цели и глас. Ще можете да го промените по-късно.';
  ...
  @override
  String get connectOmiOmiGlass => 'Свържи Chronicle / OmiGlass';
  ...
  @override
  String get omiYourAiCompanion => 'Chronicle – Вашият AI спътник';
  ...
  String get permissionGrantedNow =>
      'Разрешението е дадено! Сега:\n\nОтворете приложението Chronicle на часовника си и натиснете \"Продължи\" по-долу';
  ...
  @override
  String get clearMemoryTitle => 'Изчистване на паметта на Chronicle';

  @override
  String get clearMemoryMessage =>
      'Сигурни ли сте, че искате да изчистите паметта на Chronicle? Това действие не може да бъде отменено.';

  @override
  String get clearMemoryButton => 'Изчисти паметта';

  @override
  String get memoryClearedSuccess => 'Паметта на Chronicle за вас е изчистена';
  ...
  String get translationNoticeMessage =>
      'Chronicle превежда разговори на вашия основен език. Актуализирайте го по всяко време в Настройки → Профили.';
  ...
  @override
  String get omiSyncsAudioFiles => 'Chronicle след това синхронизира аудио файловете със сървъра';
  ...
  String get welcomeToOmiDescription =>
      'Добре дошли в Chronicle! Вашият AI спътник е готов да ви помогне с разговори, задачи и още.';

  @override
  String get startUsingOmi => 'Започнете да използвате Chronicle';
  ...
  String get startCapturingConversations =>
      'Започнете да записвате разговори с вашето устройство Chronicle, за да ги видите тук.';
  ...
  @override
  String get noTasksForToday => 'Няма задачи за днес.\nПопитайте Chronicle за повече задачи или създайте ръчно.';
  ...
  @override
  String get buildSubmitCustomOmiApp => 'Създайте и изпратете вашето персонализирано Chronicle приложение';
  ...
  String get submitAppTermsAgreement =>
      'С изпращането на това приложение приемам Условията за ползване и Политиката за поверителност на Chronicle AI';
  ...
  String get dataAccessWarning =>
      'Това приложение ще има достъп до вашите данни. Chronicle AI не носи отговорност за това как вашите данни се използват, модифицират или изтриват от това приложение';
  ...
  @override
  String get getOmiDevice => 'Вземете Chronicle устройство';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Премахни трайно всички спомени от Chronicle';
  ...
  @override
  String get clearOmisMemory => 'Изчисти паметта на Chronicle';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Сигурни ли сте, че искате да изчистите паметта на Chronicle? Това действие не може да бъде отменено и ще изтрие трайно всички $count спомена.';
  }

  @override
  String get omisMemoryCleared => 'Паметта на Chronicle за вас е изчистена';

  @override
  String get welcomeToOmi => 'Добре дошли в Chronicle';
  ...
  String get tellUsHowYouWouldLikeToBeAddressed =>
      'Кажете ни как бихте искали да се обръщаме към вас. Това помага за персонализиране на вашето Chronicle изживяване.';
  ...
  String get enableFeaturesForBestExperience =>
      'Активирайте функции за най-доброто Chronicle изживяване на вашето устройство.';
  ...
  String get microphoneAccessDescription =>
      'Chronicle се нуждае от достъп до микрофона, за да записва вашите разговори и да предоставя транскрипции.';
  ...
  String get screenRecordingDescription =>
      'Chronicle се нуждае от разрешение за запис на екрана, за да заснема системен звук от вашите срещи в браузъра.';
  ...
  String get accessibilityDescription =>
      'Chronicle се нуждае от разрешение за достъпност, за да открива кога се присъединявате към срещи в Zoom, Meet или Teams във вашия браузър.';
  ...
  @override
  String get teachOmiYourVoice => 'Научете Chronicle на вашия глас';

  @override
  String get tellOmiWhoSaidIt => 'Кажете на Chronicle кой го каза 🗣️';
  ...
  String get helpImproveOmiBySharing =>
      'Помогнете за подобряването на Chronicle чрез споделяне на анонимизирани данни за анализ';
  ...
  String get mcpDescription =>
      'За свързване на Chronicle с други приложения за четене, търсене и управление на вашите спомени и разговори. Създайте ключ, за да започнете.';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'Опитайте най-новите експериментални функции от екипа на Chronicle.';
  ...
  @override
  String get letOmiChooseAutomatically => 'Нека Chronicle избере най-доброто приложение автоматично';
  ...
  @override
  String get addWordsDescription => 'Добавете думи, които Chronicle трябва да разпознава по време на транскрипция.';
  ...
  @override
  String get connectOmiWithAI => 'Свържете Chronicle с AI асистенти';
  ...
  @override
  String get bySubmittingYouAgreeToOmi => 'С изпращането се съгласявате с Chronicle ';
  ...
  String get dataAccessNoticeDescription =>
      'Това приложение ще има достъп до вашите данни. Chronicle AI не носи отговорност за начина, по който вашите данни се използват, променят или изтриват от това приложение';
  ...
  @override
  String get omiApiKeys => 'Chronicle API ключове';
  ...
  @override
  String get aboutOmiApiKeys => 'Относно Chronicle API ключове';
  ...
  String get e2eeDescription =>
      'Криптирането от край до край е златният стандарт за поверителност. Когато е активирано, вашите данни се криптират на вашето устройство, преди да бъдат изпратени до нашите сървъри. Това означава, че никой, дори Chronicle, не може да получи достъп до вашето съдържание.';
  ...
  String get secureEncryptionDescription =>
      'Вашите данни са криптирани с ключ, уникален за вас, на нашите сървъри, хоствани в Google Cloud. Това означава, че вашето сурово съдържание е недостъпно за никого, включително персонала на Chronicle или Google, директно от базата данни.';
  ...
  @override
  String get omiTraining => 'Обучение на Chronicle';
  ...
  String get getOmiUnlimitedFree =>
      'Получете Chronicle Unlimited безплатно, като допринесете данните си за обучение на AI модели.';
  ...
  @override
  String get yourOmiUnleashed => 'Вашият Chronicle, освободен. Станете неограничени за безкрайни възможности.';
  ...
  @override
  String get askOmiAnything => 'Попитайте Chronicle каквото и да е за живота си';

  @override
  String get unlockOmiInfiniteMemory => 'Отключете безкрайната памет на Chronicle';
  ...
  String get privacyIntroText =>
      'В Chronicle приемаме поверителността ви много сериозно. Искаме да бъдем прозрачни относно данните, които събираме и как ги използваме за подобряване на продукта. Ето какво трябва да знаете:';
  ...
  String get commitmentText =>
      'Ние сме ангажирани да използваме събраните данни само за да направим Chronicle по-добър продукт за вас. Вашата поверителност и доверие са от първостепенно значение за нас.';

  @override
  String get thankYouText =>
      'Благодарим ви, че сте ценен потребител на Chronicle. Ако имате въпроси или притеснения, не се колебайте да се свържете с нас на team@basedhardware.com.';
  ...
  String get howPeopleWorks =>
      'След като създадете човек, можете да отидете в транскрипция на разговор и да му зададете съответните сегменти, така Chronicle ще може да разпознава и неговата реч!';
  ...
  @override
  String get installOmiOnAppleWatch => 'Инсталирайте Chronicle на вашия\nApple Watch';

  @override
  String get installOmiOnAppleWatchDescription =>
      'За да използвате Apple Watch с Chronicle, първо трябва да инсталирате приложението Chronicle на часовника си.';

  @override
  String get openOmiOnAppleWatch => 'Отворете Chronicle на вашия\nApple Watch';

  @override
  String get openOmiOnAppleWatchDescription =>
      'Приложението Chronicle е инсталирано на вашия Apple Watch. Отворете го и натиснете Старт, за да започнете.';
  ...
  String get unableToOpenWatchApp =>
      'Не може да се отвори приложението Apple Watch. Моля, отворете ръчно приложението Watch на вашия Apple Watch и инсталирайте Chronicle от секцията \"Налични приложения\".';
  ...
  String get appleWatchNotReachable =>
      'Apple Watch все още не е достъпен. Моля, уверете се, че приложението Chronicle е отворено на часовника ви.';
  ...
  @override
  String get wrappedOmiLifeRecap => 'Chronicle преглед на живота';

  @override
  String get wrappedSwipeUpToBegin => 'Плъзни нагоре за начало';

  @override
  String get wrappedShareText => 'Моята 2025, запомнена от Chronicle ✨ omi.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'запомнена от Chronicle';
  ...
  @override
  String get controlNotificationFrequency => 'Контролирайте колко често Chronicle ви изпраща проактивни известия.';
  ...
  String get notificationFrequencyDescription =>
      'Контролирайте колко често Chronicle ви изпраща проактивни известия и напомняния.';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'Аудиото от вашето Chronicle устройство ще се появи тук';
  ...
  @override
  String get considerOmiCloud => 'Помислете за използване на Chronicle Cloud за по-добра производителност.';
  ...
  String get omiTranscriptionOptimized =>
      'Вградената транскрипция на живо на Chronicle е оптимизирана за разговори в реално време с автоматично разпознаване и разделяне на говорителите.';
  ...
  @override
  String get setupQuestionsIntro => 'Помогнете ни да подобрим Chronicle, като отговорите на няколко въпроса. 🫶 💜';

  @override
  String get setupQuestionProfession => '1. С какво се занимавате?';

  @override
  String get setupQuestionUsage => '2. Къде планирате да използвате вашия Chronicle?';
  ...
  @override
  String get batteryFullyChargedTitle => 'Chronicle е напълно зареден';

  @override
  String get batteryFullyChargedBody => 'Вашето устройство Chronicle е напълно заредено. Можете да го изключите!';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'Налична е нова актуализация на фърмуера ($version) за вашето Chronicle устройство. Искате ли да актуализирате сега?';
  }
  ...
  @override
  String get connectOmiDevice => 'Свържете Chronicle устройство';
  ...
  @override
  String get actionItemReminderTitle => 'Напомняне от Chronicle';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Добре дошли в Chronicle';
  ...
  @override
  String get pairingTitleOmi => 'Включете Chronicle';

  @override
  String get pairingDescOmi => 'Натиснете и задръжте устройството, докато завибрира, за да го включите.';

  @override
  String get pairingTitleOmiDevkit => 'Поставете Chronicle DevKit в режим на сдвояване';
  ...
  @override
  String get pairingTitleOmiGlass => 'Включете Chronicle Glass';
  ...
  String get pairingDescAppleWatch =>
      'Инсталирайте и отворете приложението Chronicle на вашия Apple Watch, след което натиснете Свързване в приложението.';
  ...
  @override
  String get phoneCallsWithOmi => 'Телефонни обаждания с Chronicle';
  ...
  @override
  String get phoneCallsUnlimitedOnly => 'Телефонни обаждания чрез Chronicle';

  @override
  String get phoneCallsUpsellSubtitle =>
      'Правете обаждания чрез Chronicle и получавайте транскрипция в реално време, автоматични резюмета и още. Достъпно само за абонати на план Неограничен.';
  ...
  String get fairUseAboutBody =>
      'Chronicle е проектиран за лични разговори, срещи и взаимодействия на живо. Употребата се измерва по реалното открито време на реч, а не по времето на връзка. Ако употребата значително надвишава нормалните модели за неличностно съдържание, може да се приложат корекции.';
  ...
  String get improveConnectionContent =>
      'Подобрихме начина, по който Chronicle остава свързан с вашето устройство. За да активирате това, моля, отидете на страницата с информация за устройството, натиснете \"Изключване на устройството\" и сдвоете устройството си отново.';
  ...
  @override
  String get omisStorage => 'Хранилище на Chronicle';
  ...
  String get omisStorageDesc =>
      'Когато Chronicle не е свързан с телефона ви, той съхранява аудиото локално във вградената си памет. Никога няма да загубите запис.';

  @override
  String get phoneStorageDesc =>
      'Когато Chronicle се свърже отново, записите автоматично се прехвърлят на телефона ви като временно хранилище преди качване.';
  ...
  String get permissionsPageDescription =>
      'Тези разрешения са основни за работата на Chronicle. Те позволяват ключови функции като известия, базирани на местоположение изживявания и аудио запис.';

  @override
  String get permissionsRequiredDescription =>
      'Chronicle се нуждае от няколко разрешения, за да работи правилно. Моля, предоставете ги, за да продължите.';

  @override
  String get permissionsSetupTitle => 'Получете най-доброто изживяване';

  @override
  String get permissionsSetupDescription => 'Активирайте няколко разрешения, за да може Chronicle да работи магически.';
  ...
  @override
  String get feedbackTitleNotUsing => 'Какво би ви накарало да използвате Chronicle повече?';
  ...
  @override
  String get feedbackSubtitleNotUsing => 'Искаме да направим Chronicle по-полезен за вас.';
  ...
  String get appleHealthManageNote =>
      'Chronicle осъществява достъп до Apple Health чрез рамката HealthKit на Apple. Можете да отмените достъпа по всяко време от Настройките на iOS.';
  ...
  @override
  String get appleHealthFeatureChatDesc => 'Питайте Chronicle за стъпките, съня, сърдечния ритъм и тренировките.';

  @override
  String get appleHealthFeatureReadOnlyTitle => 'Достъп само за четене';

  @override
  String get appleHealthFeatureReadOnlyDesc => 'Chronicle никога не записва в Apple Health и не променя данните ви.';
  ...
  String get appleHealthDeniedBody =>
      'Chronicle няма разрешение да чете данните ви от Apple Health. Активирайте го в Настройки на iOS → Поверителност и сигурност → Health → Chronicle.';

  @override
  String get deleteFlowReasonTitle => 'Защо си тръгвате?';

  @override
  String get deleteFlowReasonSubtitle => 'Вашата обратна връзка ни помага да направим Chronicle по-добър за всички.';
  ...
  @override
  String get deleteFlowFeedbackSubtitle => 'Какво би накарало Chronicle да работи за вас?';
  ...
  String get chatQuotaExceededReply =>
      'Достигнахте месечния си лимит. Надградете, за да продължите да чатите с Chronicle без ограничения.';

  @override
  String get voiceResponseAudio => 'Прочитай отговора на Chronicle на глас';
  ...
  @override
  String get quickActionAskOmi => 'Попитайте Chronicle всичко';
  ...
  @override
  String get syncStatusUploaded => 'Качено · обработва се в Chronicle';
  ...
  String get deleteWhileProcessingMessage =>
      'Този запис е качен, но Chronicle още създава разговора. Ако го изтриете сега и обработката се провали, той не може да бъде възстановен. Изтриване въпреки това?';
  ...
  @override
  String get syncCardProcessing => 'Обработка в Chronicle…';
  ...
  String get syncFlowIntro =>
      'Записите се прехвърлят от вашето устройство на този телефон и се съхраняват локално, след което се качват на сървъра на Chronicle, където се транскрибират и се превръщат в разговори.';

  @override
  String get syncStepUpload => 'Синхронизация';

  @override
  String get syncStepUploadDesc => 'Записът ви се изпраща към сървъра на Chronicle';

  @override
  String get syncStepProcess => 'Транскрибиране';

  @override
  String get syncStepProcessDesc => 'Chronicle превръща звука в разговор';
  ...
  @override
  String get syncCardUploadingTitle => 'Качване в Chronicle';
  ...
  String get syncCardBackendBusy =>
      'Сървърите на Chronicle са натоварени — записите ви ще се синхронизират, когато се освободи капацитет';
  ...
  @override
  String get backgroundModeDescription => 'Запазете записа на Chronicle дори когато приложението е напълно затворено.';

  @override
  String get backgroundModeNote => 'Засега работи само с устройства Chronicle и непрекъснато се подобрява.';

  @override
  String get backgroundModeUnavailable =>
      'Фоновият режим не е наличен, защото няма свързано съвместимо устройство. Свържете устройство Chronicle, OpenGlass или Friend Pendant, за да използвате тази функция.';
  ...
  @override
  String get syncCustomSttWarningTitle => 'Синхронизирането използва транскрипция на Chronicle';

  @override
  String get syncCustomSttWarningMessage =>
      'Използвате собствен доставчик за транскрипция. Синхронизирането на тези записи ги транскрибира на сървърите на Chronicle и те се отчитат към лимита за транскрипция на вашия план.';
  ...
  String get transcribeLaterNote =>
      'Работи с микрофона на телефона и с устройства Chronicle и Limitless. Аудиото остава на телефона ви, докато не решите да го качите.';
  ...
  @override
  String get deviceTutorial => 'Как да използвате Chronicle';

  @override
  String get deviceOnboardingTranscriptionTitle => 'Говорете към вашето Chronicle';
  ...
  @override
  String get deviceOnboardingAskQuestionTitle => 'Задайте въпрос на Chronicle';
  ...
  @override
  String get deviceOnboardingTryDoubleTap => 'Опитайте сега! Докоснете два пъти вашето Chronicle';
  ...
  String get raybanMetaSetupDescription =>
      'Използвайте вашите очила Ray-Ban Meta като устройство за заснемане на Chronicle за разговори и визуален контекст. Chronicle ще отвори приложението Meta AI, за да свърже очилата ви.';
  ...
  String get raybanMetaCameraExplanation =>
      'Chronicle използва камерата на очилата ви, за да добавя снимки към разговорите ви. Можете да пропуснете това и да използвате само аудио.';
  ...
  String get raybanMetaAudioOnlyExplanation =>
      'Тази версия на Chronicle може да използва микрофона на очилата ви през Bluetooth. Заснемането на снимки изисква версията за разработчици на Chronicle от Meta.';
  ...
  String get rayBanMetaMicPickerDescription =>
      'Изберете Bluetooth микрофона на очилата. Музиката спира, докато Chronicle го използва.';
  ...
  @override
  String get syncStatusTooOld => 'Твърде стар за синхронизиране — Chronicle не може да го приеме';

  @override
  String get planSheetChooseYourPlan => 'Изберете своя план, за да отключите неограничен Chronicle.';
  ...
  String get freemiumLimitsIntro =>
      'Chronicle е безплатен, но безплатната версия има ограничения, които влияят на изживяването ви:';
  ...
  String get accountCutoverUpdateRequiredMessage =>
      'Установите последнее приложение Chronicle, чтобы продолжить после миграции аккаунта.';
  ...
  @override
  String get sendRawAudioToOmi => 'Изпращане на необработен звук към Chronicle';

  @override
  String get sendRawAudioToOmiDescription =>
      'Изключете, за да спрете изпращането на необработен звук към Chronicle. Транскрипции и данни, нужни за облачните функции, все още може да се изпращат към Chronicle.';
}
