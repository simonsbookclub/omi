            ...
            children: [
              CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: Selector<ConversationDetailProvider, UsInfo?>(
                      selector: (context, provider) => provider.conversation.us,
                      builder: (context, us, _) => us == null ? const SizedBox.shrink() : TalkCard(us: us),
                    ),
                  ),
            ...
            return getTranscriptWidget(
              ...
              onEditSegmentText: (segmentIndex) {
                ...
                final speakerName = person?.name ??
                    context.l10n.speakerWithId('${TranscriptSegment.getDisplaySpeakerId(segment.speakerId, segments, stream: segment.stream)}');
